  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "soft-grid":
          "radial-gradient(circle at top, rgba(23,59,122,0.08), transparent 35%), linear-gradient(transparent 31px, rgba(15,140,131,0.04) 32px), linear-gradient(90deg, transparent 31px, rgba(15,140,131,0.04) 32px)"
      },
      keyframes: {
        "fade-up": {
