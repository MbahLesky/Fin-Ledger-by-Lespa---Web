...
- Individuals who want simple income and expense tracking.
- Users who prefer quick, chat-based interactions.

### Secondary Users

- Freelancers managing personal cash flow.
- Students and young professionals tracking spending.
...
- Chatbot usage versus app usage ratio.
- User retention rate.
...
The guiding principle remains: **Make financial tracking as easy as sending a message.**
