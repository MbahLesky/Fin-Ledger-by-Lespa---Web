// Google's official four-colour "G". Kept as raw SVG rather than a lucide glyph
// because Google's branding guidelines require the exact mark on sign-in buttons.
